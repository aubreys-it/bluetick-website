...
gulp.task('scss-for-dev', ['browser-sync'], function() {
    gulp.src('./sass/*.scss')
        .pipe(plumber({
            errorHandler: function (err) {
                console.log(err);
...
gulp.task('scripts', function() {
    var scripts = [
        ...
        basePaths.dev + 'js/greensock/TweenMax.js',
        basePaths.dev + 'js/greensock/plugins/ScrollToPlugin.js',
        basePaths.dev + 'js/jquery.matchHeight.js',
        basePaths.dev + 'js/parallax.min.js',
        basePaths.dev + 'js/slick/slick.min.js',
        basePaths.dev + 'js/lity.js',
        basePaths.dev + 'js/jquery.lightbox_me.js',
        basePaths.dev + 'js/jquery.form.js',
...
// _s SCSS files
    gulp.src(basePaths.node + 'undescores-for-npm/sass/**/*.scss')
        .pipe(gulp.dest(basePaths.dev + '/sass/_oleas'));
