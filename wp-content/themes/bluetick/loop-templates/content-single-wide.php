...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	<div class="row">
		<div class="col-lg-6 col-md-12 wide-panel-image">
			<a href="<?php echo $permalink; ?>">		
			<!-- <?php echo get_the_post_thumbnail( $post->ID, 'post-image-wide' ); ?> -->
			<div class="post-bg-image" style="background-image: url(<?php echo get_the_post_thumbnail_url( $post->ID, 'post-image-wide' ); ?>)"></div>
			</a>
		</div>
		<div class="col-lg-6 col-md-12 wide-panel-content">
			<div class="post-content-wrapper">
				...
				<div class="entry-content">
					...
					echo wp_trim_words( get_the_content(), 30, '... + <a class="inline-read-more" href="'.$permalink.'"> Read More</a>' ); ?>	
